...
function tentukanDeretGeometri(arr) {
    ...
    //membuat variabel untuk manampung hasil terlebih dahulu
    var hasil = true;
    //membuat variabel pengali untuk mendeteksi berapakah angka pengali
    var pengali = arr[1] / arr[0]
        // console.log(pengali)
        //looping untuk mengecek angka selanjutnya
    for (var i = 1; i < arr.length; i++) {
        //membuat kondisi untuk menemukan array mana yg tidak konsisten angka pengali nya akan langsung mereturn 'false'
        if (arr[i] / pengali !== arr[i - 1]) {
            // console.log(arr[i] + " dan " + pengali + " hasilnya "+ arr[i-1])
            return false;
            // }else{
            // console.log(arr[i] + " dan " + pengali + " hasilnya "+ arr[i-1]
        }
